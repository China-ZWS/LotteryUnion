...
@property (nonatomic, retain) UIView *parentView;  //父视图

@property (nonatomic, retain) UIView *dialogView;    // Dialog's container view

@property (nonatomic, retain) UIView *containerView; // 内容视图

@property (nonatomic, retain) UIView *buttonView;    //按钮视图

@property (nonatomic, assign) id<CustomIOS7AlertViewDelegate> delegate;

@property (nonatomic, retain) NSArray *buttonTitles;   //按钮标题数组
