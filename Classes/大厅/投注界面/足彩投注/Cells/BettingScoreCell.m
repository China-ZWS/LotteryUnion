...
@interface BettingScoreCollectCell : PJCollectionViewCell

@end

@implementation BettingScoreCollectCell

@end

@interface BettingScoreCell ()

@end

@implementation BettingScoreCell
...
- (void)setDatas:(id)datas
{
    ...
    /*修改AbstractsText*/
    _abstracts.attributedText = [FootBallModel setScroeTextWithDatas:model.scroes];
}
